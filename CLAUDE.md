# MercuryResource - Claude Code Guide

## Site
- URL: https://mercuryresource.net
- Repo: https://github.com/corganb/mercuryresource
...
- Cloudflare Pages project name: `mercuryresource-site`
...
2. **Cache-bust core.js after edits.** Bump `?v=N` on the `<script src>` tag. Current: `v=16`.
...
## Mercury quirks
- Spacecraft present in scene: BepiColombo, Mariner 10
